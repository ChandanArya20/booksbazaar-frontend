...
const CategoryResultPage = ({ categoryName }) => {
    ...
    const applyFilters = () => {
        ...
        let isAtLeastOneTrue = Object.values(languageFilters).some(
            (value) => value === true
        );
        //apply language filter
        if (isAtLeastOneTrue) {
            filteredBooks = originalBooks.filter(
                (book) => languageFilters[book.language]
            );
        }
        ...
        <>
            ...
            <div className="category-result-container">
                {loading ? (
                    ...
                    <div className="empty-cart empty-cart-special-case">
                    ...
                    <>
                        <div
                            className={`category-result-filter ${
                                showFilter ? "category-result-filter-model" : ""
                            }`}
                        >
                            <div
                                className="category-filter-modal-cross-button"
                                onClick={closeModel}
                            >
                                <CloseIcon />
                            </div>
